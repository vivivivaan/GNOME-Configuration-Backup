...
`sudo ./install.sh -d /usr/local/share/themes/ -c dark -a alt -t blue -s nord -l --shell -h smaller -ns -normal`

### /usr/share/themes/
`sudo ./install.sh -d /usr/share/themes/ -c dark -a alt -t blue -s nord -l --shell -h smaller -ns -normal`

### ~/.local/share/themes/
`./install.sh -d ~/.local/share/themes/ -c dark -a alt -t blue -s nord -l --shell -h smaller -ns -normal`

### GDM Tweaks
`sudo ./tweaks.sh -g -b <wallpaper location> -h smaller -nb -c dark -t blue -s nord && sudo ./tweaks.sh -F -c dark -t blue -s nord`
...
alias clean="sudo dnf clean all && ud"
